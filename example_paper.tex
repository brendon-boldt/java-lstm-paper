...
\icmltitlerunning{Using LSTMs to Model the Java Programming Languages}

\begin{document} 

\twocolumn[
    \icmltitle{Using LSTMs to Model the Java Programming Language}
    
    % It is OKAY to include author information, even for blind
    % submissions: the style file will automatically remove it for you
    % unless you've provided the [accepted] option to the icml2013
    % package.
    \icmlauthor{Brendon Boldt}{brendon.boldt1@marist.edu}
    \icmlauthor{Pablo Rivas}{pablo.rivas@marist.edu}
    % feel free to remove me at the end if you think I have not done 
    % sufficient work to deserve co-authorship, or also if you are entering a
...
networks (LSTMs), are particularly good at performing next word prediction 
...
language. Java source code from four different data sets
...
Results suggest that LSTMs, under the proposed model, can effectively model
