...
Results suggest that LSTM used can more effectively model Java code 
than it can English (a perplexity of $85$ and an accuracy of $0.27$ for an
English corpus and
perplexities under $22$ and accuracies above $0.47$ for Java corpora).
These findings could be useful in areas such as 
syntactic template suggestion and automated bug patching.
\end{abstract} 
